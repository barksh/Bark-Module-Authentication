...
export type InquiryActionPayloadType<T extends InquiryActionType> = T extends InquiryActionType.CALLBACK ? string : T extends InquiryActionType.WEBHOOK ? string : T extends InquiryActionType.CLOSE ? undefined : never;
